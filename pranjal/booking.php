...
<div class="container-fluid">
	<form action="" id="manage-book">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="contact"  value="<?php echo isset($contact) ? $contact :'' ?>" required onkeypress="return/[0-9]/i.test(event.key)" maxlength="10" pattern-"([0-9]) [10,)">
